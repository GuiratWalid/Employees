    ...
    <body style="display: flex;">
        ...
        <div>
            ...
            <div class="vertical-menu">
                ...
                <a href='./listEmploye.jsp'>Liste des employés</a>
                <a href='./listEmployeNonConfirme.jsp'>Liste des employés non confirmés</a>
                <a href='./listDemande.jsp'>Liste des demandes</a>
                <a href='./listDemandeNonConfirme.jsp'>Liste des demandes non confirmées</a>
            </div>
