        ...
        <table id="customers">
           ...
           <%
            try {
                ...
                ResultSet rs = st.executeQuery("select e.nom,e.prenom,d.* from demande d, employe e where e.login = d.employe and d.etat = 'sous'"); 
                while(rs.next()){%>
                <tr>
                        ...
                        <td><%=rs.getString(2)+" "+rs.getString(1)%></td>
                            <td>
                                <form action="/TP8-war/ConfirmerDemande" method="POST">
                            ...
                            <td>
                                 <form action="/TP8-war/RefuserDemande" method="POST">
                                    <input type="text" name="id" id="id" value="<%=rs.getString(3)%>" style="visibility:hidden;width:1px;"/>
